...
/**
 * <p>Java class for FailedCreditTransferResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="FailedCreditTransferResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="FailedPmntDtls" type="{urn:com:sentenial:origix:ws:credittransfer-ws}FailedCtDtls" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "FailedCreditTransferResponse", propOrder = {
    "returnCode",
    "returnDesc",
    "creditorRef",
    "rtxCreateDate",
...
@XmlSeeAlso({
    ListFailedCreditTransferResponse.class
})
public class FailedCreditTransferResponse {
    ...
    protected List<FailedCtDtls> failedPmntDtls;
     ...
     * 
     */
    public List<FailedCtDtls> getFailedPmntDtls() {
        if (failedPmntDtls == null) {
            failedPmntDtls = new ArrayList<FailedCtDtls>();
        }
